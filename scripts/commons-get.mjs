...
// Downloads a Wikimedia Commons file (free licences only) and prints its attribution.
//   node scripts/commons-get.mjs "File:Walk-in cooler (3894648278).jpg" public/demo/walk-in-fridge.jpg
...
if (!/^(CC BY|CC BY-SA|CC0|Public domain)/i.test(lic)) { console.error(`${title}: licence ${lic} is not free`); process.exit(2); }
